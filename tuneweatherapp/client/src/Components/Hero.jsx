      ...
      <div className="flex flex-col mt-12 bg-transparent mx-auto w-full px-4">
        <section id="hero" className="flex flex-col-reverse my-16 mx-auto">
          <div id="headText" className="flex flex-col items-center justify-between rounded-2xl">
            <div className={`${playlistSectionHeadersHidden ? "hidden" : ""} sm:mx-12 md:mx-8 lg:mx-12 mt-8 mb-12 xl:mx-242`}>
              <h2 className="text-5xl font-extrabold text-gray-900 -my-14 sm:-mx-4 sm:text-5xl slg:text-7xl lg:text-7xl lg:mx-7 md:text-center md:text-6xl lg:text-center xl:text-center xl:text-7xl xxl:text-[5rem] mx-4">
            ...
            <div className="sm:mx-12 md:mx-8 lg:mx-12 mt-8 mb-12 xl:mx-24">
              <h2 className={`${mainHeaderHidden ? "hidden" : ""} text-5xl text-left tracking-tight text-gray-800 font-extrabold sm:-mx-4 sm:text-5xl slg:text-7xl lg:text-7xl lg:mx-7 md:text-center md:text-6xl lg:text-center xl:text-center xl:text-7xl xxl:text-8xl mx-4`}>
