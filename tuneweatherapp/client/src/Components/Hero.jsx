      ...
      <div className="flex flex-col mt-12 bg-transparent mx-auto w-full px-4">
        <section id="hero" className="flex flex-col-reverse my-16 mx-auto">
          <div id="headText" className="flex flex-col items-center justify-between rounded-2xl">
            ...
            <div className="sm:mx-12 md:mx-8 lg:mx-12 xl:mx-24">
              <h2 className={`${mainHeaderHidden ? "hidden" : ""} text-5xl text-left tracking-tight text-gray-800 font-extrabold sm:text-5xl md:text-center md:text-6xl lg:text-center lg:text-6xl xl:text-center xl:text-7xl mx-4`}>
