...
const logoutHover = () => {
    ...
    return (
        <div className="relative group inline-block">
            <FaSignOutAlt className="text-white text-2xl cursor-pointer transition-all hover:text-gray-600" onMouseOver={logoutHover} onMouseLeave={() => setLogoutHidden(true)} />
