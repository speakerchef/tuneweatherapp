        ...
        <section id="hero" className="flex flex-col-reverse my-16 mx-auto">
          <div id="headText" className="flex flex-col items-center justify-between rounded-2xl -my-8 md:-my-4">
            <div className={`${playlistSectionHeadersHidden ? "hidden" : ""}  sm:mx-12 md:mx-8 lg:mx-12 mt-8 mb-20 xl:mx-242`}>
              <h2 className="text-5xl   font-extrabold bg-gradient-to-br from-lightMagenta to-indigo-700 bg-clip-text text-transparent opacity-85 -my-14 sm:-mx-4 sm:text-5xl slg:text-7xl lg:text-7xl lg:mx-7 md:text-center md:text-6xl lg:text-center xl:text-center xl:text-7xl xxl:text-[5rem] mx-4">
