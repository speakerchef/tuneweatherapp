            ...
            <div className=" flex flex-col bg-darkerTransparentIndigoBlue mx-auto w-full pb-20">
                <section id="hero" className="flex flex-col-reverse my-[8rem] mx-32">
                    <div id="headText" className="flex flex-col items-center justify-between rounded-2xl">
                        <div className={`${playlistSectionHeadersHidden} flex items-center flex-col mx-auto`}>
                        ...
                        <h2 className={`${mainHeaderHidden} text-4xl text-left text-tuneWeatherCream font-extrabold sm:text-4xl md:text-5xl md:text-center lg:text-center xl:text-center xl:text-7xl`}>
                ...
                <Buttons spotifyHidden={spotifyHidden}/>
